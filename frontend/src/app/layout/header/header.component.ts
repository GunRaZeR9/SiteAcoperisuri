...
export class HeaderComponent {
  ...
  private phoneCallConversionId = 'AW-17923956079/DcxiCMrEg_QbEO-65-JC';
  ...
  socialLinks = [
    ...
    { 
      name: 'Facebook', 
      url: 'https://www.facebook.com/share/1C6XHdHW2g/', 
    ...
    { 
      name: 'TikTok', 
      url: 'https://www.tiktok.com/@maestruacoperis.ro?_r=1&_t=ZN-93cIC7ykFcs', 
